...
When the system boots you'll see a welcome animation. If you would like to disable this animation for subsequent boot ups, in a Terminal, run:* `/home/ttuser/scripts/disable-demo-mode.sh`
