...
| Tenstorrent Processors | 2x Liquid-Cooled Blackhole™ cards, each equipped with:<br />2x Blackhole ASICs<br />240 Tensix Cores<br />64 GB of DDR6 Memory @ 16 GT/sec (1024 GB/sec memory bandwidth)<br />600W of board power|
...
The workstation’s internal AC/DC power supply consists of one 1600-watt 80 Plus Titanium Power Supply Unit (PSU). The expected peak power consumption of the Workstation is 1.5kW. For maximum efficiency, ensure your outlet can handle 100-240V, (15A is recommended).
