...
First, ensure that the Workstation is turned on. 
1. Confirm the power cable is securely connected, and is recieving power from a grounded outlet. 
...
If you have confirmed all cable connections, the power is on, and there is still no visual output on your connected monitor:
