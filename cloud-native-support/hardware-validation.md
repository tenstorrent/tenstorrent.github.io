...
Both run directly on the hosts, outside the Kubernetes stack — typically at
bring-up before the cloud-native components take over the machines, and again
after any recabling or hardware swap.
...
| A host or link is suspected bad | Either, scoped to the suspect hardware |
